...
export function HowItWorksPageHero() {
  ...
  return (
    <>
      {/* Mobile: compact intro — simulator is the primary experience below */}
      <section className="relative bg-void pt-20 sm:hidden">
        <div className="section-pad container-max py-5 text-center">
          <h1 className="display text-[1.65rem] font-semibold uppercase tracking-[-0.03em] text-ink">
            How It <span className="gradient-text">Works</span>
          </h1>
          <p className="mt-2 text-[0.92rem] leading-snug text-muted">
            Build a portfolio in the interactive demo below.
          </p>
        </div>
        <div
      ...
      {/* Desktop: full hero */}
      <section className="relative isolate hidden overflow-hidden bg-void pt-20 sm:block">
        <div
