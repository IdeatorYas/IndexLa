  ...
  return (
    <section className={`${invSection} bg-deep`}>
      <div className="section-pad container-max">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_auto_1fr] lg:items-center lg:gap-5">
          <FadeIn>
            <div className="rounded-[1.25rem] border border-danger/25 bg-danger/[0.06] p-6 sm:p-7">
              ...
              <ul className="mt-5 space-y-3">
                {emotions.map((item, i) => (
                  <motion.li
                    key={item}
                    className="display text-[clamp(1.25rem,2.4vw,1.65rem)] tracking-[-0.025em] text-ink"
          ...
          <FadeIn delay={0.04}>
            <div className="rounded-[1.25rem] border border-success/30 bg-success/[0.06] p-6 sm:p-7">
        ...
        <FadeIn className="mt-10 max-w-3xl space-y-4">
          ...
          <p className={invBody}>
            ...
            moves. Define the response{" "}
            <span className="font-semibold text-ink">before</span> the emotion
            arrives.
          </p>
