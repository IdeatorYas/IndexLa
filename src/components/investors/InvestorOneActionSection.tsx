        ...
        <FadeIn className="mx-auto max-w-4xl">
          ...
          >
            ...
            <div className="relative z-[1] mx-auto flex min-h-[14rem] max-w-3xl flex-col items-center justify-center sm:min-h-[16rem]">
              <p className="text-[1.35rem] font-bold leading-snug tracking-[-0.025em] text-ink text-pretty text-balance sm:text-[1.55rem] md:text-[1.7rem]">
                One action. Real assets. Your wallet. Your rules.
              </p>
              <p className="mt-8 text-[1.2rem] font-medium leading-[1.7] tracking-[-0.015em] text-muted text-pretty text-balance sm:mt-9 sm:text-[1.35rem] sm:leading-[1.75] md:text-[1.45rem]">
