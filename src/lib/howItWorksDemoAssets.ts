...
export const DEMO_CRYPTO: DemoAsset[] = [
  { ticker: "BTC", name: "Bitcoin", src: "/images/assets/demo/crypto/btc.svg" },
  { ticker: "ETH", name: "Ethereum", src: "/images/assets/demo/crypto/eth.svg" },
  { ticker: "BNB", name: "BNB", src: "/images/assets/demo/crypto/bnb.svg" },
  { ticker: "SOL", name: "Solana", src: "/images/assets/demo/crypto/sol.svg" },
  ...
  { ticker: "LINK", name: "Chainlink", src: "/images/assets/demo/crypto/link.svg" },
  ...
  { ticker: "NEAR", name: "NEAR Protocol", src: "/images/assets/demo/crypto/near.png" },
  { ticker: "ICP", name: "Internet Computer", src: "/images/assets/demo/crypto/icp.svg" },
  ...
  { ticker: "SUI", name: "Sui", src: "/images/assets/demo/crypto/sui.png" },
...
export const DEMO_STOCKS: DemoAsset[] = [
  ...
  { ticker: "MSFT", name: "Microsoft", src: "/images/assets/demo/stocks/msft.svg" },
  { ticker: "NVDA", name: "NVIDIA", src: "/images/assets/demo/stocks/nvda.svg" },
...
export const DEMO_COMMODITIES: DemoAsset[] = [
  { ticker: "GOLD", name: "Gold", src: "/images/assets/demo/commodities/gold.svg" },
...
export const DEMO_TARGET_ALLOCATION: (DemoAsset & { pct: number })[] = [
  ...
  { ticker: "NVDA", name: "NVIDIA", src: "/images/assets/demo/stocks/nvda.svg", pct: 14 },
