...
INDEXLA gives creators the infrastructure to turn research, market views, and proprietary strategies into investable portfolios.

Create a strategy. Build an audience. Attract capital. Earn as your portfolio is used.
...
Set Your Price → Users Pay in $DEXLA → Access Granted
...
$DEXLA tips also contribute to Creator ranking.

Discover → Follow → Invest → Tip → Rank

### 4. Monthly Creator Performance Rewards

A portion of protocol fees generated across INDEXLA activity funds the monthly Creator Rewards Pool.

Each month, the Top 10 portfolios qualify based on the Creator Score.
...
Hold the portfolio for at least 7 days + tip the creator in $DEXLA.
...
Creator Score → Leaderboard → Top 10 → Ranked Reward Allocation

Rewards are designed around genuine portfolio activity. Artificial activity, wash trading, and self-tipping do not qualify.
...
INDEXLA turns creator expertise into a portfolio-based business where better strategies attract capital, activity creates revenue, and performance creates additional rewards for both creators and the investors who support them.
